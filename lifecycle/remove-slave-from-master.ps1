...
if ($removed -eq 0) {
  ...
  Say "remove-slave: $map on branch $master and the install branch $SlaveFqdn still stand. They are the git side of the registration, and dropping them is what tears the per-slave reconciler instance down"
}
else {
